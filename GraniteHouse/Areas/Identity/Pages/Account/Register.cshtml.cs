        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(StaticDetails.SuperAdmin))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(StaticDetails.SuperAdmin));
                    }

                    if (Input.IsSuperAdmin)
                    {
                        await _userManager.AddToRoleAsync(user, StaticDetails.SuperAdmin);
                    }
                    else
                    {
